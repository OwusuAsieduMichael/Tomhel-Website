      ...
      <Section>
        <Container>
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <FadeIn>
              <TabsList className="surface-card mb-8 flex h-auto w-full flex-wrap justify-start gap-1 p-1.5">
                ...
                <div className="columns-1 gap-4 sm:columns-2 lg:columns-3">
                  {category.images.map((src, index) => (
                    <FadeIn key={src} delay={index * 0.05}>
                      <div className="surface-card mb-4 break-inside-avoid overflow-hidden p-0">
                        <div
